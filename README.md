<p align="center">
  <img src="https://img.shields.io/badge/Version-V7.1-blueviolet?style=for-the-badge" />
...
| **Stealth Calculator Mode** | App disguises itself as a calculator in the launcher — enter a secret code to unlock |
...
| **Emoji Reactions** | Quick-react bar: 👍 ❤️ 😂 😮 😢 🔥 — sent as `REACT:` protocol messages |
| **Reply Threading** | Swipe-to-reply with quoted message preview |
...
| `REACT:` | `sender\|time\|REACT:msgId§emoji` | Emoji reaction |
...
- Opening the app shows a working calculator
- Enter secret code `1337=` to unlock Ghost Chat
